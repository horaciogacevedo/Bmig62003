...
Let's suppose we observe a quantitative response $Y$ and $p$ different predictors $X_1,\ldots, X_p$, which can be written in the form $$
Y= f(X) + \varepsilon
...
### Modern dilemma with Deep Learning

New deep learning methods have changed the traditional perspective of testing vs. training errors.

![](images/fig_gitta_news.jpg){fig-align="center" width="220mm"}

A very interesting reading from a mathematician Gitta Kutyniok [SIAM news](https://www.siam.org/publications/siam-news/articles/the-mathematics-of-reliable-artificial-intelligence/)
