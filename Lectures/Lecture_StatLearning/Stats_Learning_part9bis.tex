...
\begin{frame}{$p$-values}
	We were familiar from basic statistics courses about the normally distributed instances. But from the previous discussion we can see that the same ideas can expand to accomodate
...
\begin{frame}{Correct or not correct that is the question...}
	...
	For instance, if you have a small animal experiment using transcriptomics for the comparison of a case and control. If your conditions are very stringent for multiple comparison adjustments, you may not be able to find other possible interactions that may be occuring. Sometimes, you cannot even conduct a "pathway analysis" if you have very few hits. 
